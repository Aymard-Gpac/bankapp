...
export const ScheduledTransactionDAO = {
  ...
  /**
   * verifie le nombre de transactions programmées actives liées à un compte (avant de fermer un compte ou de supprimer un bénéficiaire)
   * @param {*} userId 
   * @param {*} accountId 
   * @returns 
   */
  countActiveByAccountId(userId, accountId) {
  return db.get(
